...
exports.ReadinessCheckComponent = void 0;
const logger_1 = require("../utils/logger");
class ReadinessCheckComponent {
    constructor() {
        // Default criteria for interim analysis
        this.interimAnalysisCriteria = {
        ...
        this.logger = (0, logger_1.createLogger)('ReadinessCheckComponent');
    }
    /**
     * Check readiness for interim analysis
     */
    checkInterimAnalysisReadiness(patients, metrics) {
        try {
            return this.performReadinessCheck(patients, metrics, 'interim_analysis', this.interimAnalysisCriteria);
        }
        catch (error) {
            this.logger.error('Interim analysis readiness check failed', error);
            throw error;
        }
    }
    /**
     ...
     */
    checkSubmissionReadiness(patients, metrics) {
        try {
            return this.performReadinessCheck(patients, metrics, 'submission', this.submissionCriteria);
        }
        catch (error) {
            this.logger.error('Submission readiness check failed', error);
            throw error;
        }
    }
    /**
     ...
     */
    performReadinessCheck(patients, metrics, checkType, criteria) {
        try {
     ...
     */
    calculateDataCompleteness(patients) {
     ...
     */
    calculateVerificationPercentage(patients) {
        if (patients.length === 0)
            return 0;
     ...
     * Generate recommendations
     */
    generateRecommendations(issues, checkType) {
     ...
     * Set custom criteria
     */
    setInterimAnalysisCriteria(criteria) {
        this.interimAnalysisCriteria = { ...this.interimAnalysisCriteria, ...criteria };
    }
    /**
     * Set custom submission criteria
     */
    setSubmissionCriteria(criteria) {
        this.submissionCriteria = { ...this.submissionCriteria, ...criteria };
    }
}
exports.ReadinessCheckComponent = ReadinessCheckComponent;
//# sourceMappingURL=ReadinessCheckComponent.js.map