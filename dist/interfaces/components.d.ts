 ...
 */
import { DataQualityIssue, OperationalMetric, Insight, Alert, DataSource, ValidationResult, PaginationParams, PaginatedResponse } from '../types/index';
...
export interface IOperationalAnalyticsComponent {
    analyzeOperationalMetrics(metrics: OperationalMetric[], timeWindow: {
        start: Date;
        end: Date;
    }): Promise<unknown>;
